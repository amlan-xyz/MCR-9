...
import {PlaylistContext, WatchlaterContext} from '../../index'
import { useNavigate } from 'react-router-dom';

export function Card({video,playlistName}){
	...
	const {removeVideo} =useContext(PlaylistContext)
			...
			<div className="card_body">
					...
					<div className="card_content">
						...
						<div className="card_btns">
							<button onClick={()=>{
								removeVideo(playlistName,_id);
							}} className='primary_btn'>Remove from Playlist</button>
						</div>
